...
public: 
  ...
  //elenago
  Vector_d<Real_t>* fx_elem;
  Vector_d<Real_t>* fy_elem;
  Vector_d<Real_t>* fz_elem;
  Vector_d<Real_t>* dev_mindtcourant;
  Vector_d<Real_t>* dev_mindthydro;
  ...
  cudaEvent_t time_constraint_computed[512];
  cudaEvent_t time_constraint_reduced[512];

  Real_t time_h ;               /* current time */
  Real_t * time_h_async ;               /* current time */



  Real_t deltatime_h ;          /* variable time increment */
  Real_t * deltatime_h_async ;
  Real_t * deltatime_d_async ;
  ...
  Index_t octantCorner;
   ...
   //
   // MPI-Related additional datadtcourant_h
   //
   ...
   Real_t *commDataSend_multi[80] ; //26*3
   Real_t *commDataSendStream_multi[80] ;
   Real_t *commDataRecv_multi[80] ;

   //elenago
   Real_t * timerRecvBuf; //to be set dynamic
   Real_t * timerSendBuf;
...
void CommRecv(Domain& domain, Int_t msgType, Index_t xferFields,
              ...
              bool doRecv, bool planeOnly, int typeBuf);
void CommSend(Domain& domain, Int_t msgType,
              Index_t xferFields, Domain_member *fieldData,
              Index_t dx, Index_t dy, Index_t dz,
              bool doSend, bool planeOnly, int typeBuf);
void CommSBN(Domain& domain, Int_t xferFields, Domain_member *fieldData, int typeBuf);
...
void CommSendGpu(Domain& domain, Int_t msgType,
              Index_t xferFields, Domain_member *fieldData,
              Index_t dx, Index_t dy, Index_t dz,
              bool doSend, bool planeOnly, cudaStream_t stream, int typeBuf);
void CommSBNGpu(Domain& domain, Int_t xferFields, Domain_member *fieldData, cudaStream_t *streams, int typeBuf);
